        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
          ...
          <div className="flex items-center mb-6 lg:mb-0">
            <p className="w-full text-sm px-4 text-justify">
              ...
              newest addition to the Leo Multiple District 306 family, we strive
              to uphold the values of leadership, experience, and opportunity
              while creating sustainable impact across Sri Lanka.
            </p>
          </div>
